...
PROVIDER_CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "config_fields": [
            ...
            {"name": "coligada", "label": "Codigo da Coligada (CODCOLIGADA)", "type": "text",
    ...
    },
    {
        ...
        "config_fields": [
            {"name": "base_url", "label": "URL base", "type": "url", "required": True},
            {"name": "students_endpoint", "label": "Endpoint de alunos", "type": "text",
             "required": False, "placeholder": "/api/students"},
            {"name": "employees_endpoint", "label": "Endpoint de funcionarios", "type": "text",
             "required": False, "placeholder": "/api/employees"},
        ],
        "credential_fields": [
            {"name": "auth.type", "label": "Tipo de autenticacao", "type": "select",
             "options": ["bearer", "basic", "header"], "default": "bearer"},
            {"name": "auth.token", "label": "Token (bearer)", "type": "password",
             "required": False},
            {"name": "auth.username", "label": "Usuario (basic)", "type": "text",
             "required": False},
            {"name": "auth.password", "label": "Senha (basic)", "type": "password",
             "required": False},
            {"name": "auth.header_name", "label": "Nome do header (custom)", "type": "text",
             "required": False, "placeholder": "X-Api-Key"},
            {"name": "auth.header_value", "label": "Valor do header (custom)", "type": "password",
             "required": False},
        ],
    },
]
